                          ...
                          endKeyFrame:(IFTTTAnimationKeyFrame *)endKeyFrame
{
    ...
    if ([self getRed:&startRed green:&startGreen blue:&startBlue alpha:&startAlpha fromColor:startKeyFrame.color] &&
        [self getRed:&endRed green:&endGreen blue:&endBlue alpha:&endAlpha fromColor:endKeyFrame.color]) {
...
- (BOOL)getRed:(CGFloat*)red green:(CGFloat*)green blue:(CGFloat*)blue alpha:(CGFloat*)alpha fromColor:(UIColor *)color {
    CGFloat white;
